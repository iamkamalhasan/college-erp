...
const Registration = () => {
  const data1 = [2017,2018,2019,2020,2021, 2022, 2023, 2024, 2025, 2026, 2027, 2028];
  ...
  const saveEnrol = () => {
    setLoading(true);
    const url = '/pc/courseregistration';
    axios
  ...
  const saveApprove = () => {
    setLoading1(true);
    const url = '/pc/courseregistration/approvestudents';
                ...
                <table className="w-full divide-y divide-gray-200 text-sm text-left sm:rounded-lg">
                  {studentListTable.studentsList && expand && (
                    <tr className="rounded-t-lg bg-gray-100 text-xs uppercase">
                      ...
                      <th className="px-5 py-3 text-gray-600 text-left text-xs font-semibold uppercase tracking-wider"> Approval</th>
                      <th className="px-5 py-3 text-gray-600 text-left text-xs font-semibold uppercase tracking-wider"> Approval-FA</th>
                    </tr>
                  )}
                  <tbody className="divide-y divide-gray-200">
