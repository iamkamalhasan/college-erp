...
const Enrollment = () => {
  const data1 = [2018,2019,2020,2021, 2022, 2023, 2024, 2025, 2026, 2027, 2028];
  ...
  const saveApprove = () => {
    setLoading1(true);
    const url = '/pc/enrolment/approvestudents';
                ...
                <table className="w-full divide-y divide-gray-200 text-sm text-left sm:rounded-lg">
                  {studentListTable.studentsList && expand && (
                    <tr className="rounded-t-lg bg-gray-100 text-xs uppercase">
                      ...
                      <th className="px-5 py-3 text-gray-600 text-left text-xs font-semibold uppercase tracking-wider"> Approval</th>
                      <th className="px-5 py-3 text-gray-600 text-left text-xs font-semibold uppercase tracking-wider"> Approval-Status</th>
                    </tr>
                  )}
                  <tbody className="divide-y divide-gray-200">
                        ...
                        return (
                          <>
                            <tr className="px-6 py-4 text-sm font-medium text-gray-800 whitespace-nowrap hover:bg-sky-50" key={element._id}>
                              ...
                              <td className="flex px-6 py-4 text-sm text-gray-800 ">
                                {element["approval"] >= 2 ? (
                                  <input id="default-checkbox" type="checkbox" value="" className={`w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600 ${element["approval"] === -1 && "marker:text-sky-500"}`} onChange={handleClick(studentListTable.courseCode,element)} checked/>
                                ) : (
                                  <input id="default-checkbox" type="checkbox" value="" className={`w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600 ${element["approval"] === -1 && "marker:text-blue-500"}`} onChange={handleClick(studentListTable.courseCode,element)}/>
                                )}
                              </td>
