...
//  }, []);
 ...
 const deleteStudent = (courseCode, ind) => (e) => {
  ...
  const url = '/admin/courseregistration/removestudents';
      axios
...
const handleOKClick = (addrow) => {
  ...
  const url = '/admin/courseregistration/addstudents';
      axios
        .post(url, addstudent)
        .then((res) => {
...
const handleInput = (e) => {
  ...
  if(enrol === true){
    ...
    const saveEnrol = () => {
      setLoading(true);
      const url = '/admin/courseregistration/getdata';
      axios
    ...
    const saveApprove = () => {
      setLoading1(true);
      const url = '/admin/courseregistration/approve';
      axios
        .post(url, approve)
        .then((res) => {
          if(res.data.success){
