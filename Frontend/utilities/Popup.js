...
const defaultMessage = "This is an irreversible action. Caution is needed when performing a one-time operation. Make sure that the consequences are understood"
 ...
 * @param open @type Function - React `setState` method signature
